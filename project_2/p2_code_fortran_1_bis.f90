...
!2nd Practice Non-Equilibrium Statistical Physics (2-change of noise initial conditions)
program practica2
    implicit none
    ...
    do j=1,3
        deallocate(delta,MSD,val_t,vector_var,vector_PBC)
        tau=tau_vec(j)
        dt=tau/20.d0
        t_max=tau*100.d0
        Np=int(t_max/dt)
        ...
        do i=1,N
            do k=1,Np+1
                MSD(k)=0.d0
            enddo
            call boxmuller_2(sqrt(D/tau),0.d0,g1,g2)
            x_ini=genrand_real3()*L-L/2.d0
